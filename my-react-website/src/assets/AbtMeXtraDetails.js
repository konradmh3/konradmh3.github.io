      ...
      return (
        <>
          <div className="extraDetails">
            ...
            <p>
              My home town is Long Beach, California! I was born here and have
              lived here for 23 years now!
            </p>
          </div>
        </>
      );
      ...
      return (
        <>
          <div className="extraDetails">
            ...
            <button onClick={closeMoreDetails}>X</button>
            <p>
              My personal website is built with react, framer motion for
              animation!
            </p>
          </div>
        </>
      ...
      return (
        ...
        <>
          <div className="extraDetails">
            ...
            <iframe
              style={{ height: "40vh" }}
              src="https://www.youtube.com/embed/Ls3ZGHq0C3c?si=4O_JOzaibWULeWYv&amp;autoplay=1&loop=10&modestbranding=1&showinfo=0"
