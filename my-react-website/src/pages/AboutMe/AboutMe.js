...
const AboutMe = () => {
  ...
  , [clickedIndex]);
    ...
    <>
      ...
      <AboutMeDescription setDetailBackColor={setDetailBackColor} backColor={'blue'} setClickedIndex={setClickedIndex} setMoreDetailsOpen={setMoreDetailsOpen} index={0} ref={aboutMeRefs[0]} title="Home Town" text="My home town is Long Beach, California! I was born here and have lived here for 23 years now!" />
      ...
      <AboutMeDescription setDetailBackColor={setDetailBackColor} backColor={'orange'} setClickedIndex={setClickedIndex} setMoreDetailsOpen={setMoreDetailsOpen} index={3} ref={aboutMeRefs[3]} title="FoodDood" text="FooDood is a mobile app built with react native to help local businesses grow and consumers eat!"/>
      <AboutMeDescription setDetailBackColor={setDetailBackColor} backColor={'black'} setClickedIndex={setClickedIndex} setMoreDetailsOpen={setMoreDetailsOpen} index={4} ref={aboutMeRefs[4]} title="This Website!" text="My personal website is built with react, framer motion for animation!" />
      <AboutMeDescription setDetailBackColor={setDetailBackColor} backColor={'darkgray'} setClickedIndex={setClickedIndex} setMoreDetailsOpen={setMoreDetailsOpen} index={5} ref={aboutMeRefs[5]} title="Stick" text="Stick is a 2D platformer built with unity!" />
      <CodeSubtitles titleClass="Grind" state="0" />


      <CodeSubtitles titleClass="Grind"  prop1="work" propText='"Experience"' state="1" />
      <AboutMeDescription setDetailBackColor={setDetailBackColor} backColor={'white'} setClickedIndex={setClickedIndex} setMoreDetailsOpen={setMoreDetailsOpen} index={6} ref={aboutMeRefs[6]} title="ASI" text="Associated Students Inc. for one year."/>
      <CodeSubtitles titleClass="Grind" state="0" />
      ...
      <motion.div style={{left: "0%", backgroundColor: detailBackColor}} animate={{height: moreDetailsOpen ? "100%": "0%"}} transition={{duration: 1, delay:0}} className="detailSection"></motion.div>
      <motion.div style={{left: "25%", backgroundColor: detailBackColor}} animate={{height: moreDetailsOpen ? "100%": "0%"}}transition={{duration: 1, delay:0.25}} className="detailSection"></motion.div>
      <motion.div style={{left: "50%", backgroundColor: detailBackColor}} animate={{height: moreDetailsOpen ? "100%": "0%"}}transition={{duration: 1, delay:0.50}} className="detailSection"></motion.div>
      <motion.div style={{left: "75%", backgroundColor: detailBackColor}} animate={{height: moreDetailsOpen ? "100%": "0%"}}transition={{duration: 1, delay:0.75}} className="detailSection"></motion.div>
      </motion.div>
